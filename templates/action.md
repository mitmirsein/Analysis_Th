## 신학 콘텐츠 심층 분석 — 단계별 실행 템플릿 v 5.2  
*(Last updated: 2025-07-01, synchronized with Main Prompt v 4.2)*  

---

**Version history:**  
* v 4.0 – 메인 프롬프트 v 3.1과 완전 동기화, Phase 기반 구조 재편성  
* v 5.0 – 메인 프롬프트 v 4.0 반영, Phase 0 추가, 적응형 분석, 한국 신학 통합  
* v 5.1 – 메인 프롬프트 v 4.1 반영, 서술체 지침 추가 및 문체 통일  
* v 5.2 – 메인 프롬프트 v 4.2 반영, Phase 2.5(수렴도 평가) 신설, 통계 유효성·가중치·상충 해소 규범 추가, 진행률·품질 체크리스트 개정  
